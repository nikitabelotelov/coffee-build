...
Object.defineProperty(exports, "__esModule", { value: true });
exports.StmCommands = exports.StmMessages = void 0;
var StmMessages;
...
/***/ "./src/ManagerPanel/Colors/Color.tsx":
/*!*******************************************!*\
  !*** ./src/ManagerPanel/Colors/Color.tsx ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var ColorView_1 = __importDefault(__webpack_require__(/*! ./ColorView */ "./src/ManagerPanel/Colors/ColorView.tsx"));
var mapStateToProps = function (state) {
    return __assign({}, state);
};
var Color = react_redux_1.connect(mapStateToProps)(ColorView_1.default);
exports.default = Color;


/***/ }),

/***/ "./src/ManagerPanel/Colors/ColorView.tsx":
/*!***********************************************!*\
  !*** ./src/ManagerPanel/Colors/ColorView.tsx ***!
  \***********************************************/
/*! no static exports found */
...
var react_color_1 = __webpack_require__(/*! react-color */ "./node_modules/react-color/lib/index.js");
function hexTo16bit(hexColor) {
    var hex = hexColor.hex.slice(1);
    var red = Math.round(Number.parseInt(hex.slice(0, 2), 16) / 255 * 15);
    var green = Math.round(Number.parseInt(hex.slice(2, 4), 16) / 255 * 15);
    var blue = Math.round(Number.parseInt(hex.slice(4, 6), 16) / 255 * 15);
    return { red: red, green: green, blue: blue };
}
function coldHandler(newColor) {
    var parsedColor = hexTo16bit(newColor);
...
var ColorView = function (props) {
    var _a = React.useState("#0000FF"), cold = _a[0], setCold = _a[1];
    var _b = React.useState("#FF0000"), hot = _b[0], setHot = _b[1];
    return (React.createElement("div", { className: "setting__profile-parameters panel_root" },
        React.createElement("div", { className: "setting__profile-parameters__color manager-panel__block manager-panel__top" },
            React.createElement("div", { className: "manager-panel__block" },
                React.createElement(react_color_1.HuePicker, { color: cold, onChangeComplete: function (color) {
                        coldHandler(color);
                        setCold(color.hex);
                    } }),
                React.createElement("p", null, "\u0425\u043E\u043B\u043E\u0434\u043D\u0430\u044F \u043C\u0430\u0448\u0438\u043D\u0430"),
                React.createElement(react_color_1.HuePicker, { color: hot, onChangeComplete: function (color) {
                        hotHandler(color);
                        setHot(color.hex);
                    } }),
                React.createElement("p", null, "\u0413\u043E\u0440\u044F\u0447\u0430\u044F \u043C\u0430\u0448\u0438\u043D\u0430"),
...
var Color_1 = __importDefault(__webpack_require__(/*! ./Colors/Color */ "./src/ManagerPanel/Colors/Color.tsx"));
...
function Panel() {
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(react_router_dom_1.Route, { exact: true, path: "*/settings/color", component: Color_1.default }),
...
var AutoMode = function (props) {
    ...
    return (React.createElement("div", { className: "setting__profile-parameters2 panel_root" },
    ...
    return (React.createElement("div", { className: "" }, isUpdate ? "Ждем завершения обновления" :
        React.createElement("div", { className: 'manager-panel__update panel_root' },
            ...
            React.createElement("div", { onClick: function () {
                ...
                React.createElement("div", null, "\u041D\u0430\u0447\u0430\u0442\u044C \u043F\u0440\u043E\u0446\u0435\u0441\u0441 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F")),
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Wifi = exports.WifiView = void 0;
var react_router_dom_1 = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/esm/react-router-dom.js");
var react_1 = __importStar(__webpack_require__(/*! react */ "react"));
var types_1 = __webpack_require__(/*! ../types */ "./src/types.ts");
...
function WifiView(opts) {
    ...
    react_1.useEffect(function () {
        ...
        interval = window.setInterval(function () {
            ...
            SettingsStore_1.emitWifiListUpdate();
        }, 5000);
        return function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.emitWifiListUpdate = exports.emitUpdate = exports.emitConnectToWifi = exports.emitChoosenProfileChange = exports.emitSettingsChange = exports.getLocalState = void 0;
...
exports.emitWifiListUpdate = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.update = exports.connectWifiNet = exports.setProfile = exports.setSetting = void 0;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getBackLink = exports.WIFI_STATUS = exports.ProcessStatus = void 0;
var Converter_1 = __webpack_require__(/*! ../server/stm/Converter */ "./server/stm/Converter.ts");
var ProcessStatus;
